        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PrecioId = table.Column<long>(type: "bigint", nullable: true),
                    Status = table.Column<string>(type: "text", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_t_carrito_t_producto_PrecioId",
                        column: x => x.PrecioId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "id");
                    table.ForeignKey(
                        name: "FK_t_order_detail_t_producto_PrecioId",
                        column: x => x.PrecioId,
                        principalTable: "t_producto",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_t_order_detail_PrecioId",
                table: "t_order_detail",
                column: "PrecioId");
